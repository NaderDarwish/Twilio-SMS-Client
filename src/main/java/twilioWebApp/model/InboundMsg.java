...
public class InboundMsg {
    ...
    public InboundMsg(Integer id, String from_num, String to_num, String body, Date msg_date, Integer user_id) {
        this.id = id;
    ...
    public InboundMsg(String from_num, String to_num, String body, Date msg_date, Integer user_id) {
        this.user_id = user_id;
        this.to_num = to_num;
        this.from_num = from_num;
        this.body = body;
